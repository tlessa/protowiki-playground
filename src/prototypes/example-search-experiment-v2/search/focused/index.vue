            ...
            <div class="focused-search-dive-card">
              <div class="focused-search-dive-card__body">
                <div class="focused-search-dive-card__top-row">
                  ...
                  <button type="button" class="focused-search-dive-card__gear" aria-label="Settings" @click="showDiveSettings = true">
      ...
      <div v-if="showDiveSettings" class="dive-settings-overlay" @click.self="showDiveSettings = false">
        <div class="dive-settings-sheet" role="dialog" aria-modal="true" aria-label="Dive settings">
          ...
          <div class="dive-settings-sheet__row">
            ...
            <button
              type="button"
              class="dive-settings-toggle"
              :class="{ 'dive-settings-toggle--on': moduleVisible }"
              :aria-checked="moduleVisible"
              role="switch"
              aria-label="Module visibility"
              @click="moduleVisible = !moduleVisible"
            >
              <span class="dive-settings-toggle__thumb" />
            </button>
          </div>
...
.focused-search-dive-card__gear {
  position: absolute;
  top: 10px;
  right: 10px;
  background: none;
