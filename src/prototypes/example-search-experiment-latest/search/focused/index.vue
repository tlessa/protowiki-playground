...
const QUERY_CARD_SETS: WikiSemanticResult[][] = [
  ...
  // Set 1 ── "what are cranes"
  [
    { title: 'Crane (machine)', sectionTitle: '', anchor: '', extract: 'A crane is a machine used to move materials both vertically and horizontally, utilizing a system of a boom, hoist, wire ropes or chains, and sheaves for lifting and relocating heavy objects within the swing of its boom. The device uses one or more simple machines, such as the lever and pulley, to create mechanical advantage to do its work. Cranes are commonly employed in transportation for the loading and unloading of freight, in construction for the movement of materials, and in manufacturing for the assembling of heavy equipment.', thumbnailUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/4a/Crane_machine_slewing_platform.svg/330px-Crane_machine_slewing_platform.svg.png' },
    { title: 'List of cranes', sectionTitle: '', anchor: '', extract: 'Cranes are tall wading birds in the family Gruidae. Cranes are found on every continent except for South America and Antarctica and inhabit a variety of open habitats, although most species prefer to live near water. They are large birds with long necks and legs, a tapering form, and long secondary feathers on the wing that project over the tail.', body: 'Most species have muted gray or white plumages, marked with black, and red bare patches on the face, but the crowned cranes of the genus Balearica have vibrantly-coloured wings and golden "crowns" of feathers. Cranes fly with their necks extended outwards instead of bent into an S-shape (differentiating them from the similar-looking herons) and their long legs outstretched. They also have musical, long-reaching calls and elaborate courtship displays.', thumbnailUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/d/db/Blue_Cranes_%28Anthropoides_paradiseus%29_couple_parading_..._%2832457893122%29.jpg/330px-Blue_Cranes_%28Anthropoides_paradiseus%29_couple_parading_..._%2832457893122%29.jpg' },
    { title: 'Cranes of Great Britain', sectionTitle: '', anchor: '', extract: 'Cranes are large, long-legged and long-necked birds of the order Gruiformes.', body: 'Two species occur as wild birds in Great Britain: the common crane (Grus grus), a scarce migrant and very localised breeding resident currently being reintroduced to the country, and the sandhill crane (Antigone canadensis), an extreme vagrant from North America. A third species, the demoiselle crane (Grus virgo), has been recorded on a number of occasions, but these birds have not generally been accepted as being of wild origin.', thumbnailUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/b4/Crane_%28Grus_grus%29_Slimbridge.jpg/330px-Crane_%28Grus_grus%29_Slimbridge.jpg' },
  ],
  // Set 2 ── "rna vs dna"
  [
