...
onMounted(() => {
  if (!localStorage.getItem('v1-search-onboarded')) {
    router.replace('/example-search-experiment-v1/onboard')
  }
})
</script>
...
<template>
  <WireframeMobileWrapper>
    ...
    <WireframeChromeWrapper
      active-tab="search"
      home-url="/example-search-experiment-v1"
      search-url="/example-search-experiment-v1/search"
    ...
    >
      ...
      <section class="search-surface">
        <RouterLink
          to="/example-search-experiment-v1/search/focused"
